 ...
 */
final class Version20210927015726 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE app_customer (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(100) NOT NULL, phone_number VARCHAR(12) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
